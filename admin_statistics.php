...
// Pairnei ta dedomena apo to: admin_statistics_mysql kai ta eisagei sto div: stage
echo ' 
<html>
	<head>
		...
		<script type = "text/javascript" language = "javascript">
			...
			function startRefresh() {
				...
				$.get("admin_statistics_mysql.php", function(data) {
					$("#stage").html(data);    
				});
			}
   ...
   <body>
	 <div id = "stage"> </div>';
		...
		echo '
	<form id="menu-button2" action="admin_index.php" method="get">
